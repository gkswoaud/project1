...
.big img{border:1px solid lightgray;}
...
<div id="jb-content">
 ...
 <%
  ...
  if(currentPage > group){
   prePage = startPage -1;
 %>
   <a href="domestic.jsp?page=<%=prePage %>">[이전]</a>
 <%
  }
  ...
  for(int i = startPage; i <= endPage ; i++ ){
   if( i != currentPage){
 %>
    <a href="domestic.jsp?page=<%=i %>"><%=i %></a>  
 <%  }else{ 
 %>
    <%=i %>
 <%
 ...
 %>
   <a href="domestic.jsp?page=<%=nextPage %>">[이후]</a>
 <%
  }
 %>
